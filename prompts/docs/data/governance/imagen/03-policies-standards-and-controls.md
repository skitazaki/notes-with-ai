...
Create a polished 1536 × 1024 pixels technical infographic titled **Policies, Standards & Controls**.
...
Inside the Control column, place a compact inset labeled **Control Objective** with a small target icon above three equal mode badges:

- **Prevent** — shield icon
- **Detect** — magnifying-glass icon
- **Correct** — tool icon
...
- Crisp vector-style shapes, simple geometry, and balanced whitespace
- Warm off-white background with dark navy typography and outlines
- Teal for Principle and Policy; blue-green for Standard; blue and slate for Control; restrained violet for Evidence
- Consistent flat icon family, rounded rectangular containers, and uniform line weight
- High-contrast typography readable at documentation-column width
- Solid connectors only
- Vendor-neutral and timeless, with no product branding

## Output

- 1536 × 1024 pixels
- 3:2 landscape aspect ratio
- High-quality raster image suitable for use as a Hugo page resource
