...
type: image
path: /docs/arch
description: Overview figure for the Software Architecture hub page.
---

# Image Generation Prompt - Software Architecture Overview
...
- light background
- restrained color palette with 5 to 6 coordinated colors
- readable labels
- 16:9 aspect ratio
