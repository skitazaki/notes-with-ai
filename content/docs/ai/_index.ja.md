...
| データとコンテキスト               | どのような情報がシステムを支え、また制約するのか                     | 学習データ、ラベリング、埋め込み、メタデータ、検索、メモリ              |
...
**生成 AI** では、プロンプト、コンテキスト、検索、ファインチューニング、ツール呼び出し、メモリ、計画、エージェント的実行を通じて構築される対話型・生成型のシステムを扱います。
