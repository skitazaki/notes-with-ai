...
![戦略的資産としてのデータの概念図。データ取得層の各ソースがデータ収集へ集まり、活用基盤層内のデータ取り込みから Raw、Transform、Curate、Trusted へ進み、そのフローをデータエンジニアリング、データアーキテクチャ、データマネジメント、メタデータが支え、統制層が全体に適用される](data-hero.ja.webp "戦略的資産としてのデータ")
