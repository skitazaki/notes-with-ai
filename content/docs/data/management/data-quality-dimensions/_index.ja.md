...
title: "データ品質の観点"
weight: 1
prev: "/ja/docs/data/management"
next: "/ja/docs/data/management/mdm"
---
...
多くの業界フレームワークは、正確性、完全性、一貫性、適時性、一意性、妥当性という 6 つの中核となる品質観点に集約されます。
...
![3 列のグリッド構成で、正確性、完全性、一貫性、適時性、一意性、妥当性を含む中核パネルを中心に、構造、実行時、意味、ガバナンス、AI の各拡張パネルが短い線で接続されたデータ品質モデル](data-quality-dimensions-ja-ChatGPT.webp "データ品質の観点")
...
![品質観点から運用管理までの概念を、定義と測定、評価、運用のグループに整理した図](data-quality-control-concepts-ja-ChatGPT.webp "品質観点から運用管理まで")
