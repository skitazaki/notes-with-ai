...
![6 つの中核品質観点を中心に、構造、実行時、意味、ガバナンス、AI の拡張レイヤーが配置されたデータ品質モデル](data-quality-dimensions-ChatGPT.webp)
...
![品質観点、メトリクス、チェック、制約、ルール、シグナル、インシデント、SLA の関係を示すデータ品質統制概念図](data-quality-control-concepts-ChatGPT.webp)
