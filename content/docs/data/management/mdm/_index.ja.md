...
title: "マスタデータ管理（MDM）"
weight: 2
prev: "/ja/docs/data/management/data-quality-dimensions"
next: "/ja/docs/data/management/reference-data"
---
...
マスタデータは参照データと混同されがちですが、実務ではこの違いは重要です。 [参照データ](/ja/docs/data/management/reference-data/) は、許容される値や共有コード体系を管理します。一方、マスタデータはエンティティそのものを表します。たとえば製品カテゴリコードは参照データですが、そのカテゴリに属する製品自体はマスタデータです。
...
このため MDM は、[データ品質の観点](/ja/docs/data/management/data-quality-dimensions/) で説明されている中核的な品質観点のいくつかを直接的に支えます。
