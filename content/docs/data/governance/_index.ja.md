...
![戦略からレビューまでを7種類のアイコン付き工程で時計回りに循環し、中央に中央集権・連合型・ハイブリッドでの信頼できるデータ活用、上部に説明責任、下部に支援レイヤーとしてのメタデータを配置したデータガバナンスの制御ループ](data-governance-control-loop.ja.png "データガバナンスの制御ループ")
