...
| **データガバナンス**                                | 意思決定権、ポリシー、説明責任、統制。 [データの統制層](/ja/docs/data/#4-統制層) と [フェデレーテッドガバナンス](/ja/docs/data/metadata/federated-governance/) を参照 |
...
![データアーキテクチャを、生成元、移動、保存と処理、提供、オーナーシップ、トレードオフという 6 つの意思決定領域で捉え、メタデータ、ガバナンス、セキュリティ、プライバシー、信頼性、可観測性が全領域を支えることを示す概念図](data-architecture-dimensions.ja.webp "データアーキテクチャの 6 つの意思決定領域")
...
![ソースから取り込みと統合、保存と処理、提供とセマンティックアクセスを経て利用者へ至るデータの流れと、全段階を横断するメタデータ、ガバナンス、セキュリティ、プライバシー、信頼性、可観測性を示すデータアーキテクチャ参照モデル](architectural-reference-model.ja.webp "データアーキテクチャ参照モデル")

横断的な関心事には、複数の境界に執行点が必要です。 [メタデータ](/ja/docs/data/metadata/) は定義、リネージ、オーナーシップ、自動化を接続し、 [データプライバシー](/ja/docs/data/privacy/) は収集と利用を形作ります。信頼性と可観測性は、インターフェースが約束を満たしているかを明らかにします。
...
| ドメイン横断でオーナーシップを拡張する      | [データメッシュ](/ja/docs/data/metadata/data-mesh/) と [フェデレーテッドガバナンス](/ja/docs/data/metadata/federated-governance/)                                   |
...
| 分散データを統制する                        | [メタデータ](/ja/docs/data/metadata/) と [フェデレーテッドガバナンス](/ja/docs/data/metadata/federated-governance/)                                                 |
