...
![データアーキテクチャを、生成元、移動、保存と処理、提供、オーナーシップ、トレードオフという 6 つの意思決定領域で捉え、メタデータ、ガバナンス、セキュリティ、プライバシー、品質、可観測性が全領域を支えることを示す概念図](data-architecture-dimensions.ja.webp "データアーキテクチャの 6 つの意思決定領域")
