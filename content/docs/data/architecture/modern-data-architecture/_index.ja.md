...
![多様なデータソースから移動手段を通り、並行するストレージと処理の経路を経て、提供インターフェースと利用者へつながる相互作用する能力のグラフと、それらを支えるメタデータ、信頼性、リネージ、セキュリティ、ガバナンス、可観測性を示すモダンデータアーキテクチャ](modern-data-architecture.ja.webp "モダンデータアーキテクチャの能力")
