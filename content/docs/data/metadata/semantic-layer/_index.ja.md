...
![統制されたセマンティックモデルを運用する3つの実装方式として、SQL生成、セマンティックAPI、外部クエリプランナーへのメタデータ提供を比較した概念図](semantic-layer-implementation-patterns.ja.webp)
...
![需要の特定と定義の比較から、結果の検証、業務フローへの組み込み、測定と改善まで、一つの概念からセマンティックレイヤーを導入する7ステップの流れ](semantic-layer-adoption-workflow.ja.webp)
