...
- [データ](/ja/docs/data/) — ライフサイクル、活用基盤、価値、統制の全体像
- [データマネジメント](/ja/docs/data/management/) — 品質、アクセス性、ライフサイクル、持続性
- [メタデータ](/ja/docs/data/metadata/) — 発見、意味、リネージ、契約、自動化
- [データ共有](/ja/docs/data/sharing/) — 境界を越える統制された生成側と利用側の関係
- [データプロダクト](/ja/docs/data/metadata/data-products/) — オーナーシップとサービス期待値を備えた利用可能なインターフェース
- [ソフトウェアアーキテクチャ](/ja/docs/arch/) — 関心事、ビュー、レイヤー、フロー、オーナーシップ境界、意思決定フレームワーク
- [AI のためのデータ](/ja/docs/ai/data-for-ai/) — AI システム向けの信頼できるデータと検索コンテキスト
