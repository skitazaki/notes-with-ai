...
![ソフトウェアエンジニアリングを、システムを形にする、品質を確かめ届ける、運用し進化させるという三つの領域に整理し、セキュリティ、ライフサイクル、横断的な関心事、AI 支援・エージェント型エンジニアリングとの関係を示す全体図](software-engineering-landscape.ja.webp "ソフトウェアエンジニアリングの全体像")
